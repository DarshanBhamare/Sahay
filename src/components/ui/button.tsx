  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:scale-105 hover:shadow-md active:scale-95",
        ...
        ocean: "bg-gradient-ocean text-primary-foreground hover:shadow-[0_10px_30px_-10px_hsl(var(--primary)/0.4)] hover:scale-105 hover:-translate-y-0.5 active:scale-95 animate-gradient",
        government: "bg-gradient-government text-primary-foreground hover:shadow-[0_10px_30px_-10px_hsl(var(--accent)/0.4)] hover:scale-105 hover:-translate-y-0.5 active:scale-95 animate-gradient",
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-[0_15px_35px_-10px_hsl(var(--primary)/0.5)] hover:scale-110 hover:-translate-y-1 active:scale-95 animate-gradient",
      },
      size: {
